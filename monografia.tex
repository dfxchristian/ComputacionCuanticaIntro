...
\begin{enumerate}
    ...
    \item[{[10]}] Preskill, J. (2023). \textit{Quantum Computing in the NISQ era and beyond (actualización y materiales del curso).} California Institute of Technology. https://theory.caltech.edu/~preskill/

    \item[{[11]}] Bub, J. (2016). \textit{Bananaworld: Quantum Mechanics for Primates.} Oxford University Press.

    \item[{[12]}] Miranda, E. R. (2022). \textit{Quantum Computer Music: Foundations, Methods and Advanced Concepts.} Springer. https://doi.org/10.1007/978-3-031-13909-3

    \item[{[13]}] Miranda, E. R. (2024). \textit{Quantum computer music: What the heck?} CTM Festival Magazine. https://www.ctm-festival.de/magazine/quantum-computer-music-what-the-heck

    \item[{[14]}] Fundación Telefónica. (2025). \textit{TELOS 129: Inspiración cuántica.} https://telos.fundaciontelefonica.com
    
    \item[{[15]}] Chow, J. C. L. (2024). \textit{Quantum Computing in Medicine}. \textit{Medical Sciences}, 12(4), 67. https://doi.org/10.3390/medsci12040067
    
    \item[{[16]}] IBM Quantum Learning. (2025). \textit{IBM Quantum Learning}. https://quantum.cloud.ibm.com/learning/en/courses/quantum-machine-learning/introduction

    \item[{[17]}] BBVA. (2025). \textit{Así es el mapa mundial de la computación cuántica}. BBVA Noticias. https://www.bbva.com/es/innovacion/asi-es-el-mapa-mundial-de-la-computacion-cuantica/

    \item[{[18]}] Williams, L. (2026). \textit{US Iran war: Will helium shortages risk major disruption to quantum computing companies?} Verdict. https://www.verdict.co.uk/us-iran-war-will-helium-shortages-risk-major-disruption-to-quantum-computing-companies/

    \item[{[19]}] ICFO. (2017). \textit{Quantum machine learning}. Phys.org. https://phys.org/news/2017-09-quantum-machines.html

    \item[{[20]}] Caballar, R. D. (2026). \textit{Q-Day has already begun. Are you ready?} IBM Think. https://www.ibm.com/think/news/q-day-has-already-begun-are-you-ready

    \item Humble, T. S., McCaskey, A., Lyakh, D. I., Gowrishankar, M., Frisch, A., \& Monz, T. (2021). \textit{Quantum Computers for High-Performance Computing}. \textit{IEEE Micro}, 41(5), 15--23. https://doi.org/10.1109/MM.2021.3099140
\end{enumerate}
