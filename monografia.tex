...
\subsubsection{El paradigma de la programación en qubits}
% Aquí irá la transición del pensamiento clásico paso a paso a la manipulación de amplitudes de probabilidad.

\subsubsection{Compuertas lógicas cuánticas fundamentales}
% Aquí irá la explicación de las matrices unitarias, la compuerta Hadamard y la compuerta CNOT.

\subsubsection{El rol vital de los simuladores clásicos}
% Aquí irá la explicación de por qué se debe emular el ruido subatómico antes de usar hardware real.

\subsubsection{Entornos de desarrollo: El ecosistema IBM Quantum}
% Aquí irá el uso del Quantum Composer y el framework Qiskit en Python.
